<x-visitor-layout>
    ...
    <div class="text-center mb-1">
        ...
        <div class="flex justify-content-center align-content-center mt-2" style="margin-botton: -0.25rem">
            ...
            <!-- Logo Medik -->
            <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 mr-1" viewBox="0 0 716 235" width="100" height="50" style="shape-rendering:geometricPrecision;text-rendering:geometricPrecision;image-rendering:optimizeQuality;fill-rule:evenodd;clip-rule:evenodd">
                <defs>
    ...
    <form class="w-full sm:max-w-lg mt-2 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg" method="POST" action="{{ route('register') }}">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mt-4">
                ...
                <input id="phone" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
